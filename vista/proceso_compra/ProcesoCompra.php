...
Phx.vista.ProcesoCompra=Ext.extend(Phx.gridInterfaz,{
	...
	constructor:function(config){
        ...
        this.addButton('btnFinPro',{grupo:[0,1,2,3], text:'Fin Proc.',iconCls: 'balert',disabled:true,handler:this.onBtnFinPro,tooltip: '<b>Finzalizar Proceso</b> Finaliza el proceso y la solicitud y revierte el presupuesto. No  puede deshacerse'});
