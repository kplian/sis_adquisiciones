...
Phx.vista.CotizacionOCVb = {
    ...
    constructor: function(config) {        
         ...
         Phx.vista.CotizacionOCVb.superclass.constructor.call(this,config);
    ...
    EnableSelect:function(n){
         Phx.vista.CotizacionOCVb.superclass.EnableSelect.call(this,n,{desc_moneda_sol:this.desc_moneda});
    },
    ...
    onButtonEdit:function(){ 
            ...
            Phx.vista.CotizacionOCVb.superclass.onButtonEdit.call(this);
    ...
    fin_registro:function()
       ...
       preparaMenu:function(n){
          var data = this.getSelectedData();
          var tb =this.tbar;
          Phx.vista.CotizacionOCVb.superclass.preparaMenu.call(this,n);
          this.menuAdq.enable();
     ...
     liberaMenu:function(){
        var tb = Phx.vista.CotizacionOCVb.superclass.liberaMenu.call(this);
        if(tb){
            this.getBoton('fin_registro').disable();
            this.getBoton('btnAdjudicar').disable();
            this.getBoton('btnSolCon').disable();
