...
class MODProveedor extends MODbase{
	...
	function insertarProveedor(){ 
		...
		$this->setParametro('casilla','casilla','int4');
		$this->setParametro('telefono1_institucion','telefono1_institucion','int4');
		$this->setParametro('telefono2_institucion','telefono2_institucion','int4');
		$this->setParametro('celular1_institucion','celular1_institucion','int4');
		$this->setParametro('celular2_institucion','celular2_institucion','int4');
		$this->setParametro('fax','fax','int4');
		...
		$this->setParametro('celular1','celular1','int4');
		$this->setParametro('celular2','celular2','int4');
		$this->setParametro('telefono1','telefono1','int4');
		$this->setParametro('telefono2','telefono2','int4');
