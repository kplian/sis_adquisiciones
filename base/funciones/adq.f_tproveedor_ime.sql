	...
	***********************************/
		...
		begin
			if (pxp.f_get_variable_global('sincronizar') = 'true') then
                ...
                /*select * FROM dblink(migra.f_obtener_cadena_conexion(), 
                'SELECT *
                  FROM compro.f_tad_nuevo_proveedor_pxp_iud(''update'', '|| v_parametros.id_proveedor || ', '|| coalesce (v_parametros.id_persona::text, 'NULL') || '
                    ...
                    NULL, NULL, NULL,
                     NULL, NULL, NULL, NULL,
                      NULL, NULL, NULL, NULL, ''' ||  v_parametros.nit || ''',
                        '|| coalesce (v_parametros.id_lugar::text, 'NULL') || ', NULL, NULL, NULL, NULL,
