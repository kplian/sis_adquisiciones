...
BEGIN
	...
	***********************************/
    ...
    begin 
        ...
        WITH RECURSIVE estados_solicitud_proceso(id_proceso_wf, id_tipo_estado,id_estado_wf, id_estado_anterior, fecha_reg)AS(
     	...
     	)SELECT tp.nombre,te.nombre_estado, es.fecha_reg,es.id_tipo_estado, es.id_estado_wf, COALESCE(es.id_estado_anterior,NULL) as id_estado_anterior
    	...
    	FOR v_cotizaciones IN( 
            ...
            where cot.id_proceso_compra=v_id_estados.id_proceso_compra
               ...
               )SELECT tp.nombre||'-'||prv.desc_proveedor, te.nombre_estado, es.fecha_reg, es.id_tipo_estado, es.id_estado_wf, COALESCE(es.id_estado_anterior,NULL) as id_estado_anterior
    	...
    	FOR v_obligaciones IN( 
            ...
            where cot.id_proceso_compra=v_id_estados.id_proceso_compra
               ...
               WITH RECURSIVE estados_obligaciones(id_proceso_wf, id_tipo_estado,id_estado_wf, id_estado_anterior, fecha_reg)AS(
                   SELECT et.id_proceso_wf, et.id_tipo_estado, et.id_estado_wf, et.id_estado_anterior, et.fecha_reg
                   FROM wf.testado_wf et
                ...
                )SELECT tp.nombre||'-'||prv.desc_proveedor, te.nombre_estado, eo.fecha_reg, eo.id_tipo_estado, eo.id_estado_wf, COALESCE(eo.id_estado_anterior,NULL) as id_estado_anterior
