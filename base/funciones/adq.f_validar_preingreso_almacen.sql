...
CREATE OR REPLACE FUNCTION adq.f_validar_preingreso_almacen (
...
***************************************************************************
 SCRIPT: 		adq.f_validar_preingreso_almacen
 DESCRIPCIÓN: 	Verifica si la cotizacion tiene items almacenables para generar el preignreso en almacen
...
BEGIN
  v_nombre_funcion ='adq.f_validar_preingreso_almacen';
