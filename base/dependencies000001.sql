...
select pxp.f_insert_tgui_rol ('PREIACT.1.2', 'ADQ - Preingreso AF');
select pxp.f_insert_tgui_rol ('PREIACT.1', 'ADQ - Preingreso AF');
select pxp.f_insert_tgui_rol ('PREIACT', 'ADQ - Preingreso AF');
select pxp.f_insert_tgui_rol ('AF', 'ADQ - Preingreso AF');
select pxp.f_insert_tgui_rol ('SISTEMA', 'ADQ - Preingreso AF');
select pxp.f_insert_tgui_rol ('PREIACT.3', 'ADQ - Preingreso AF');
select pxp.f_insert_tgui_rol ('PREIACT.2.2', 'ADQ - Preingreso AF');
select pxp.f_insert_tgui_rol ('PREIACT.2', 'ADQ - Preingreso AF');
select pxp.f_insert_tgui_rol ('PREIACT.2.1.1', 'ADQ - Preingreso AF');
select pxp.f_insert_tgui_rol ('PREIACT.2.1', 'ADQ - Preingreso AF');
